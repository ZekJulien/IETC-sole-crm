...
import { LucideBuilding2, LucideTags, LucideReceipt, LucidePercent, LucidePackage } from '@lucide/angular'
import { TranslatePipe } from '@app/pipes'
import { AppRoutes } from '@app/core/routes/app-routes.const'

@Component({
  selector: 'app-settings-header',
  imports: [NgComponentOutlet, RouterLink, RouterLinkActive, LucideBuilding2, LucideTags, LucideReceipt, LucidePercent, LucidePackage, TranslatePipe],
