...
import { LucideLayoutDashboard, LucideUsers, LucideFolderKanban, LucideListTodo, LucideClock, LucideReceiptText, LucideFileText, LucideReceiptEuro, LucideSettings, LucideUserCircle2 } from '@lucide/angular'
