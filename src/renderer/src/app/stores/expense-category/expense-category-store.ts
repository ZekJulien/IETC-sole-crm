...
import { ExpenseCategoryService } from '@app/services/expense-category/expense-category'
...
export class ExpenseCategoryStore {
  private readonly categorySvc = inject(ExpenseCategoryService)
  ...
  async remove(id: number): Promise<void> {
    try {
      ...
      this.toast.success(this.i18n.t('expenseCategory.toast.deleted'))
    } catch (e) { this.errors.handle(e) }
  }
}
